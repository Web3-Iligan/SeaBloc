...
import { idlFactory } from './app_frontend.did.js';
export { idlFactory } from './app_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_APP_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./app_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the app_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./app_frontend.did.js")._SERVICE>}
 */
export const app_frontend = createActor(canisterId);
