...
import { idlFactory } from './transactions.did.js';
export { idlFactory } from './transactions.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRANSACTIONS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./transactions.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the transactions canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./transactions.did.js")._SERVICE>}
 */
export const transactions = createActor(canisterId);
