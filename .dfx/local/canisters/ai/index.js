...
export const canisterId = process.env.CANISTER_ID_AI;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ai.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ai canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ai.did.js")._SERVICE>}
 */
export const ai = createActor(canisterId);
